...
Keep route-specific implementation colocated under the corresponding route directory. Cross-route consumers must import an explicit public feature entry point instead of reaching into a `-*` module. Follow the [internationalization guide](../docs/en/guides/19-web-studio-internationalization.md) whenever a feature adds or changes user-visible text.
...
- [Web Studio internationalization guide](../docs/en/guides/19-web-studio-internationalization.md): translation ownership, dynamic server text, and the review checklist.
